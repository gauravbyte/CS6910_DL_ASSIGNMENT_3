...
if 'PYTHONPATH' in os.environ:
    if 'kaggle' in os.environ['PYTHONPATH']:
        ...
        df_train = pd.read_csv("/kaggle/input/aksharantar/aksharantar_sampled/mar/mar_train.csv")
        df_valid = pd.read_csv('/kaggle/input/aksharantar/aksharantar_sampled/mar/mar_valid.csv')
        df_test = pd.read_csv('/kaggle/input/aksharantar/aksharantar_sampled/mar/mar_test.csv')
    else:
